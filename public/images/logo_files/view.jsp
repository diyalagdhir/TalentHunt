	...
	usi_js = {
		...
		display:function(aggressive) {
			try {
				...
				usi_js.load_js('load.jsp?id='+usi_js.campaign.id+'&sid='+usi_js.campaign.site_id+'&cid='+usi_js.campaign.config_id+'&url='+encodeURIComponent(location.href), usi_js.post_display);
